...
Build useful website projects with ChatGPT, Codex, GitHub, Canva, and Cloudflare Pages.

## Workflow

- ChatGPT plans.
- Codex edits repository files.
- GitHub stores commits.
- Cloudflare Pages publishes when used.
...
- Use approved browser plugins only for safe review, testing, screenshots, SEO checks, accessibility checks, and workflow help.
...
- Gerry may use mobile to review progress, approve safe work, check GitHub, check Cloudflare Pages, and view deployed sites.
...
- Prefer simple, stable, mobile-first work.
